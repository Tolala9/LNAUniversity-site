    ...
    <div class="site-footer__inner container container--narrow">
      ...
      <div class="group">
        ...
        <div class="site-footer__col-one">
          <h1 class="school-logo-text school-logo-text--alt-color"><a href="<?php echo site_url() ?>""><strong>LNAU</strong>niversity</a></h1>
          ...
          <div class="site-footer__col-two">
            ...
            <nav class="nav-list">
              <ul>
                ...
                <li><a href="<?php echo get_post_type_archive_link('program') ?>">Faculties</a></li>
