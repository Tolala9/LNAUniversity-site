...
<body <?php body_class(); ?>>
    ...
    <div class="container">
      <h1 class="school-logo-text float-left"><a href="<?php echo site_url() ?>"><strong>LNA</strong><strong>U</strong>niversity</a></h1>
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul>
            ...
            } ?>><a href="<?php echo get_post_type_archive_link('program') ?>">Faculties</a></li>
