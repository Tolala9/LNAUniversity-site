...
var like = new _Like.default(); // alert("hello");
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join(''), "\n\t\t\t\t\t\t\t\t\t").concat(results.generalInfo.length ? '</ul>' : '', "\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class=\"one-third\">\n\t\t\t\t\t\t\t\t<h2 class=\"search-overlay__section-title\">Faculties</h2>\n\t\t\t\t\t\t\t\t\t").concat(results.programs.length ? '<ul class="link-list min-list">' : "<p>No faculties matches that search. <a href=\"".concat(universityData.root_url, "/programs\">View all programs</a></p>"), " \n\t\t\t\t\t\t\t\t\t").concat(results.programs.map(function (item) {
    ...
    value: function createLike(currentLikeBox) {
      _jquery.default.ajax({
        ...
        success: function success(responce) {
          ...
          currentLikeBox.attr("data-like", responce);
